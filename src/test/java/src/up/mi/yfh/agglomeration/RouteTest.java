...
/**
 * Classe de tests unitaires pour la classe Route.
 */
public class RouteTest {

    /**
     * Vérifie que les villes sont correctement assignées lors de la création de
     * l'objet Route.
     */
    @Test
    ...
    /**
     * Vérifie que l'égalité entre deux objets Route est correctement évaluée, même
     * si l'ordre des villes est inversé.
     */
    @Test
