package test.java.src.up.mi.yfh.gestion;

import org.junit.jupiter.api.Test;
import src.up.mi.jgm.agglomeration.CommunauteAgglomeration;
import src.up.mi.jgm.agglomeration.Ville;
import static org.junit.jupiter.api.Assertions.*;
import src.up.mi.jgm.agglomeration.Route;
public class GestionBornesRechargeTest {
    ...
    public void testListeVillesAvecBornesRecharge() {
        ...
        // Act
        String resultat = GestionBornesRecharge.listeVillesAvecBornesRecharge(communaute);
    ...
    public void testContrainteAccessibiliteBornesRechargeComplexe() {
        ...
        //1e test
        assertTrue(GestionBornesRecharge.peutRetirerBorneRecharge(A, communaute), "On devrait pouvoir retirer la borne de A");
        A.retirerBorneRecharge();
        assertTrue(GestionBornesRecharge.peutRetirerBorneRecharge(B, communaute), "On devrait pouvoir retirer la borne de B");
        B.retirerBorneRecharge();
        //la ville n'aurait pas de voisins ayant une bornes de recharge : probleme d'incohérence
        assertFalse(GestionBornesRecharge.peutRetirerBorneRecharge(D, communaute), "On ne devrait pas pouvoir retirer la borne de D");
        
        //2e test
        assertTrue(GestionBornesRecharge.peutRetirerBorneRecharge(H, communaute), "On devrait pouvoir retirer la borne de H");
        H.retirerBorneRecharge();
        assertFalse(GestionBornesRecharge.peutRetirerBorneRecharge(J, communaute), "On ne devrait pas pouvoir retirer la borne de J");
        assertFalse(GestionBornesRecharge.peutRetirerBorneRecharge(K, communaute), "On ne devrait pas pouvoir retirer la borne de K");
        assertTrue(GestionBornesRecharge.peutRetirerBorneRecharge(I, communaute), "On devrait pouvoir retirer la borne de I");
        I.retirerBorneRecharge();
        assertFalse(GestionBornesRecharge.peutRetirerBorneRecharge(C, communaute), "On ne devrait pas pouvoir retirer la borne de C");
   }
}
