...
/**
 * Classe de tests unitaires pour la classe GestionBorneRecharge.
 */
public class GestionBorneRechargeTest {

    /**
     * Teste la liste des villes avec bornes de recharge.
     */
    @Test
    ...
    /**
     * Teste la contrainte d'accessibilité des bornes de recharge.
     */
    @Test
    public void testContrainteAccessibiliteBornesRechargeComplexe() {
        ...
        // 1e test
        assertTrue(GestionBorneRecharge.peutRetirerBorneRecharge(A, communaute),
                "On devrait pouvoir retirer la borne de A");
        A.retirerBorneRecharge();
        assertTrue(GestionBorneRecharge.peutRetirerBorneRecharge(B, communaute),
                "On devrait pouvoir retirer la borne de B");
        B.retirerBorneRecharge();
        // la ville n'aurait pas de voisins ayant une bornes de recharge : probleme
        // d'incohérence
        assertFalse(GestionBorneRecharge.peutRetirerBorneRecharge(D, communaute),
                "On ne devrait pas pouvoir retirer la borne de D");

        // 2e test
        assertTrue(GestionBorneRecharge.peutRetirerBorneRecharge(H, communaute),
                "On devrait pouvoir retirer la borne de H");
        H.retirerBorneRecharge();
        assertFalse(GestionBorneRecharge.peutRetirerBorneRecharge(J, communaute),
                "On ne devrait pas pouvoir retirer la borne de J");
        assertFalse(GestionBorneRecharge.peutRetirerBorneRecharge(K, communaute),
                "On ne devrait pas pouvoir retirer la borne de K");
        assertTrue(GestionBorneRecharge.peutRetirerBorneRecharge(I, communaute),
                "On devrait pouvoir retirer la borne de I");
        I.retirerBorneRecharge();
        assertFalse(GestionBorneRecharge.peutRetirerBorneRecharge(C, communaute),
                "On ne devrait pas pouvoir retirer la borne de C");
    }
}